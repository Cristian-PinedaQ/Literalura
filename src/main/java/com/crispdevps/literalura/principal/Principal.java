package com.crispdevps.literalura.principal;

import com.crispdevps.literalura.model.Autor;
import com.crispdevps.literalura.model.DatosAutor;
import com.crispdevps.literalura.model.DatosLibro;
import com.crispdevps.literalura.model.Libro;
import com.crispdevps.literalura.repository.AutorRepository;
import com.crispdevps.literalura.repository.LibroRepository;
import com.crispdevps.literalura.service.ConsumoAPI;
import com.crispdevps.literalura.service.ConvierteDatos;
...
public class Principal {
    ...
    private void mostrarPorIdiomas() {
        ...
        switch (opcion) {
            ...
            case "5" -> idioma = "it";
            case "6" -> {
                System.out.println("Digite el código del idioma (ISO 639-1, por ejemplo: en, es, fr):");
                System.out.print("> ");
